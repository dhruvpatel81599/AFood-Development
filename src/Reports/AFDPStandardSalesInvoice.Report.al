...
report 50301 "AFDP Standard Sales Invoice"
{
    ApplicationArea = all;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/AFDPStandardSalesInvoice.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(DisplayAdditionalFeeNote; DisplayAdditionalFeeNote1)
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                dataitem(ShipmentLine; "Sales Shipment Buffer")
                {
                    ...
                    begin
                        if not DisplayShipmentInformation1 then
                            CurrReport.Break();
                ...
                begin
                    ...
                    ItemNo := Line."No.";  //AFDP 05/25/2025 'Item Code Type'
                    ...
                    //>>AFDP 05/25/2025 'Item Code Type'
                    LineQuantity := DPReportHelperFunctionsAFI.GetDocLineQuantity(Line.Units_DU_TSL, Line.Quantity);
            ...
            dataitem(LineFee; "Integer")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    if not DisplayAdditionalFeeNote1 then
                        CurrReport.Break();
            ...
            begin
                ...
                //>>AFDP 05/25/2025 'Item Code Type'                
                AFICompanyInfo := DPReportHelperFunctionsAFI.BuildCompanyInfo();
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    Caption = 'Options';
                    //>>AFDP 05/25/2025 'Item Code Type'
                    field("ShowCountryOfOrigin"; ShowCountryOfOrigin1)
                    {
                    ...
                    //<<AFDP 05/25/2025 'Item Code Type'
                    field(LogInteraction; LogInteraction1)
                    {
                    ...
                    field(DisplayShipmentInformation; DisplayShipmentInformation1)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Show Shipments';
                        ToolTip = 'Specifies that shipments are shown on the document.';
                    }
                    field(DisplayAdditionalFeeNote; DisplayAdditionalFeeNote1)
                    {
                        ApplicationArea = Basic, Suite;
        ...
        trigger OnInit()
        begin
            LogInteraction1 := LogInteractionTemplateExists();
            LogInteractionEnable := LogInteraction1;
        end;
    }
    labels
    {
    ...
    begin
        if LogInteraction1 and not IsReportInPreviewMode() then
...
#pragma warning restore AA0074
    ...
    protected var
        ...
        DisplayShipmentInformation1: Boolean;
        DisplayAdditionalFeeNote1: Boolean;
        FirstLineHasBeenOutput: Boolean;
        ShowShippingAddr: Boolean;
        TotalText: Text[50];
        LogInteraction1: Boolean;
        TotalAmount: Decimal;
    ...
    begin
        LogInteraction1 := NewLogInteraction;
    ...
    local procedure GetJobTaskDescription(JobNo1: Code[20]; JobTaskNo1: Code[20]): Text[100]
    var
        JobTask: Record "Job Task";
    begin
        JobTask.SetRange("Job No.", JobNo1);
        JobTask.SetRange("Job Task No.", JobTaskNo1);
